...
class settingsWindow {
    private containerSettings: HTMLDivElement;
    private programSelection_select: HTMLSelectElement;
    private linkerFile_textarea: HTMLTextAreaElement;
    private radioIoMapped_input: HTMLInputElement;
    private radioMemoryMap_input: HTMLInputElement;

    private io1Address_textarea: HTMLTextAreaElement;
    private io2Address_textarea: HTMLTextAreaElement;
    private io3Address_textarea: HTMLTextAreaElement;

    private io1InputRadio_input: HTMLInputElement;
    private io2InputRadio_input: HTMLInputElement;
    private io3InputRadio_input: HTMLInputElement;

    private io1OutputRadio_input: HTMLInputElement;
    private io2OutputRadio_input: HTMLInputElement;
    private io3OutputRadio_input: HTMLInputElement;

    private io1Arrow_div: HTMLDivElement;
    private io2Arrow_div: HTMLDivElement;
    private io3Arrow_div: HTMLDivElement;

    private ramAddress_select: HTMLSelectElement;
    private breakpointsCheckbox_input: HTMLInputElement;
    private breakpointsCheckbox_div: HTMLDivElement;
    ...
    constructor() {
        ...
        this.programSelection_select = <any>getHtmlElement('programSelection_select');
        this.linkerFile_textarea = <HTMLTextAreaElement>getHtmlElement('linkerFile_textarea');
        this.radioIoMapped_input = <HTMLInputElement>getHtmlElement('radioIoMapped_input');
        this.radioMemoryMap_input = <HTMLInputElement>getHtmlElement('radioMemoryMap_input');

        this.io1Address_textarea = <HTMLTextAreaElement>getHtmlElement('io1Address_textarea');
        this.io2Address_textarea = <HTMLTextAreaElement>getHtmlElement('io2Address_textarea');
        this.io3Address_textarea = <HTMLTextAreaElement>getHtmlElement('io3Address_textarea');

        this.io1InputRadio_input = <HTMLInputElement>getHtmlElement('io1InputRadio_input');
        this.io2InputRadio_input = <HTMLInputElement>getHtmlElement('io2InputRadio_input');
        this.io3InputRadio_input = <HTMLInputElement>getHtmlElement('io3InputRadio_input');

        this.io1OutputRadio_input = <HTMLInputElement>getHtmlElement('io1OutputRadio_input');
        this.io2OutputRadio_input = <HTMLInputElement>getHtmlElement('io2OutputRadio_input');
        this.io3OutputRadio_input = <HTMLInputElement>getHtmlElement('io3OutputRadio_input');

        this.io1Arrow_div = <HTMLDivElement>getHtmlElement('io1Arrow_div');
        this.io2Arrow_div = <HTMLDivElement>getHtmlElement('io2Arrow_div');
        this.io3Arrow_div = <HTMLDivElement>getHtmlElement('io3Arrow_div');

        this.ramAddress_select = <HTMLSelectElement>getHtmlElement('ramAddress_select');
        this.breakpointsCheckbox_input = <HTMLInputElement>getHtmlElement('breakpointsCheckbox_input');
        this.breakpointsCheckbox_div = <HTMLDivElement>getHtmlElement('breakpointsCheckbox_div');

        this.errorWindow_div = <HTMLDivElement>getHtmlElement('errorWindow_div');
        this.errorMessage_textarea = <HTMLTextAreaElement>getHtmlElement('errorMessage_textarea');
    }
...
export const containerSettings_div = <HTMLDivElement>getHtmlElement('containerSettings_div');
        
const programSelection_select = <HTMLSelectElement>getHtmlElement('programSelection_select');
const linkerFile_textarea = <HTMLTextAreaElement>getHtmlElement('linkerFile_textarea');
const radioIoMapped_input = <HTMLInputElement>getHtmlElement('radioIoMapped_input');
const radioMemoryMap_input = <HTMLInputElement>getHtmlElement('radioMemoryMap_input');

const io1Address_textarea = <HTMLTextAreaElement>getHtmlElement('io1Address_textarea');
const io2Address_textarea = <HTMLTextAreaElement>getHtmlElement('io2Address_textarea');
const io3Address_textarea = <HTMLTextAreaElement>getHtmlElement('io3Address_textarea');

const io1InputRadio_input = <HTMLInputElement>getHtmlElement('io1InputRadio_input');
const io2InputRadio_input = <HTMLInputElement>getHtmlElement('io2InputRadio_input');
const io3InputRadio_input = <HTMLInputElement>getHtmlElement('io3InputRadio_input');

const io1OutputRadio_input = <HTMLInputElement>getHtmlElement('io1OutputRadio_input');
const io2OutputRadio_input = <HTMLInputElement>getHtmlElement('io2OutputRadio_input');
const io3OutputRadio_input = <HTMLInputElement>getHtmlElement('io3OutputRadio_input');

const io1Arrow_div = <HTMLDivElement>getHtmlElement('io1Arrow_div');
const io2Arrow_div = <HTMLDivElement>getHtmlElement('io2Arrow_div');
const io3Arrow_div = <HTMLDivElement>getHtmlElement('io3Arrow_div');

const ramAddress_select: any = <HTMLSelectElement>getHtmlElement('ramAddress_select');
const breakpointsCheckbox_input = <HTMLInputElement>getHtmlElement('breakpointsCheckbox_input');
const breakpointsCheckbox_div = <HTMLDivElement>getHtmlElement('breakpointsCheckbox_div');

const errorWindow_div = <HTMLDivElement>getHtmlElement('errorWindow_div');
const errorMessage_textarea = <HTMLTextAreaElement>getHtmlElement('errorMessage_textarea');
...
const setSettingsDependingOnProgram = (ioMapped_boolean: boolean, io1IN_boolean: boolean, io2IN_boolean: boolean, io3IN_boolean: boolean, io1AddressHex_string: string, io2AddressHex_string: string, io3AddressHex_string: string, ramStartingAddressHex_string: string): void => {
    ...
    for (let i = 0; i < ramAddress_select.children.length; i++) {
        if ((<HTMLOptionElement>ramAddress_select.children[i]).value === ramStartingAddressHex_string) {
...
const updateProgram = (): void => {
    switch (programSelection_select.value) {
        case 'own':
            linkerFile_textarea.value = linkerFileExamplePrograms[0];
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', '2000');
            break;
        case 'bsp1':
            linkerFile_textarea.value = linkerFileExamplePrograms[1];
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', '2000');
            break;
        case 'bsp2':
            linkerFile_textarea.value = linkerFileExamplePrograms[2];
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', '2000');
            break;
        case 'bsp3':
            linkerFile_textarea.value = linkerFileExamplePrograms[3];
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', '2000');
            break;
        case 'bsp4':
            linkerFile_textarea.value = linkerFileExamplePrograms[4];
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', '2000');
            break;
        case 'bsp5':
            linkerFile_textarea.value = linkerFileExamplePrograms[5];
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', 'E000');
            break;
        case 'bsp6':
            linkerFile_textarea.value = linkerFileExamplePrograms[6] ;
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', 'E000');
            break;
        case 'bsp7':
            linkerFile_textarea.value = linkerFileExamplePrograms[7];
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', 'E000');
            break;
        case 'bsp8':
            linkerFile_textarea.value = linkerFileExamplePrograms[8];
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', 'E000');
            break;
        case 'bsp9':
            linkerFile_textarea.value = linkerFileExamplePrograms[9];
            setSettingsDependingOnProgram(true, true, false, true, '00', '01', '02', '2000');
            break;
        case 'bsp10':
            linkerFile_textarea.value = linkerFileExamplePrograms[10];
            setSettingsDependingOnProgram(true, true, false, false, '01', '03', '05', 'E000');
            break;
        case 'bsp11':
            linkerFile_textarea.value = linkerFileExamplePrograms[11];
            setSettingsDependingOnProgram(false, true, false, true, 'A000', 'A001', 'A002', 'E000');
            break;
        case 'bsp12':
            linkerFile_textarea.value = linkerFileExamplePrograms[12];
            setSettingsDependingOnProgram(true, true, false, false, '01', '03', '05', 'E000');
            break;
        case 'bsp13':
            linkerFile_textarea.value = linkerFileExamplePrograms[13];
            setSettingsDependingOnProgram(true, true, true, false, '00', '01', '02', '2000');
            break;
        case 'bsp14':
            linkerFile_textarea.value = linkerFileExamplePrograms[14];
            setSettingsDependingOnProgram(true, true, true, false, '00', '01', '02', '2000');
            break;
        case 'bsp15':
            linkerFile_textarea.value = linkerFileExamplePrograms[15];
            setSettingsDependingOnProgram(true, true, true, false, '00', '01', '02', '2000');
            break;
        case 'bsp16':
            linkerFile_textarea.value = linkerFileExamplePrograms[16];
            setSettingsDependingOnProgram(true, true, true, false, '00', '01', '02', '2000');
            break;
        case 'bsp17':
            linkerFile_textarea.value = linkerFileExamplePrograms[17];
            setSettingsDependingOnProgram(true, true, true, false, '00', '01', '02', '2000');
            break;
        case 'bsp18':
            linkerFile_textarea.value = linkerFileExamplePrograms[18];
            setSettingsDependingOnProgram(true, true, true, false, '00', '01', '02', '2000');
            break;
        case 'bsp19':
            linkerFile_textarea.value = linkerFileExamplePrograms[19];
...
for (let i = 0; i < ramOptions.length; i++) {
    ramOptions[i].addEventListener('click', function () {
        ramAddress_select.value = (<HTMLOptionElement>ramAddress_select.children[i]).value;
        changeRamAddress();
...
for (let i = 0; i < programOptions.length; i++) {
    programOptions[i].addEventListener('click', function () {
        programSelection_select.value = (<HTMLOptionElement>programSelection_select.children[i]).value;
        updateProgram();
