            ...
            romElement.addEventListener('mouseover', function () {
                ...
                for (var j_1 = 0; j_1 < mc8Commands_array.length; j_1++) {
                    if (mc8Commands_array[j_1].machineCommand_number === convertHexToNumber(romElement.value)) {
                        breakpointsLabel_p.textContent = (mc8Commands_array[j_1].assemblerNotation_string);
                        check = false;
...
var Point = /** @class */ (function () {
    function Point(index_number, parentIndex_number, x_number, y_number, label_string) {
...
var animateALU = function (aluOUT_number, twoMovingAluElements_boolean, cFlag_boolean, saveToRegister_string) { return __awaiter(_this, void 0, void 0, function () {
    var xCoordinateAlu1, xCoordinateAlu2, yCoordinate, speed, j, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 40:
                ...
                return [3 /*break*/, 48];
            case 41:
                if (!(IR.value_number === 233)) return [3 /*break*/, 45];
                assemblerCommand_p.textContent = 'JP [IX]';
                return [4 /*yield*/, animateStepDescriptionUpdate('Lade den Programmzähler')];
            case 42:
                _a.sent();
                return [4 /*yield*/, animateTransfer('IX', 'PC', IX.value_number)];
            case 43:
                _a.sent();
                return [4 /*yield*/, animateRegisterUpdate('PC', IX.value_number)];
            case 44:
                _a.sent();
                return [3 /*break*/, 48];
            case 45: return [4 /*yield*/, addYellowBackgroundForIDLETIME(IR.htmlElement)];
            case 46:
                _a.sent();
                return [4 /*yield*/, animateArrow('IR')];
            case 47:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 22:
                _a.sent();
                return [3 /*break*/, 26];
            case 23: return [4 /*yield*/, addYellowBackgroundForIDLETIME(IR.htmlElement)];
            case 24:
                _a.sent();
                return [4 /*yield*/, animateArrow('IR')];
            case 25:
