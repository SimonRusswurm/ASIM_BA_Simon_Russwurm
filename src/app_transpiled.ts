    ...
    if(!playStatus.noAnim){
        switch (arrow_string) {
            case 'PC':
                ...
                try{await sleepForIDLETIME();}
                finally{registerArrow_div.classList.remove('PC_arrow');}
                break;
            
            case 'ZR':
                registerArrow_div.classList.add('ZR_arrow');
                try{await sleepForIDLETIME();}
                finally{registerArrow_div.classList.remove('ZR_arrow');}
                break;
            
            case 'HL':
                registerArrow_div.classList.add('HL_arrow');
                try{await sleepForIDLETIME();}
                finally{registerArrow_div.classList.remove('HL_arrow');}
                break;
            
            case 'IX':
                registerArrow_div.classList.add('IX_arrow');
                try{await sleepForIDLETIME();}
                finally{registerArrow_div.classList.remove('IX_arrow');}
                break;
            
            case 'SP':
                registerArrow_div.classList.add('SP_arrow');
                try{await sleepForIDLETIME();}
                finally{registerArrow_div.classList.remove('SP_arrow');}
                break;

            case 'IR':
                irArrow_div.classList.add('ir_arrow');
                try{await sleepForIDLETIME();}
                finally{irArrow_div.classList.remove('ir_arrow');}
                break;

            case 'FLAGS':
                movingFlagsArrow_div.classList.add('flags_arrow');
                try{await sleepForIDLETIME();}
                finally{movingFlagsArrow_div.classList.remove('flags_arrow');}
                break;
